      ...
      >
        ...
        <div className="min-h-0 flex-1 overflow-y-auto px-[22px] py-[12px]">
          {messages.length === 0 && pending === null ? (
            <p
              className="chrome text-[10px] leading-[1.6] tracking-[0.06em]"
              style={{ color: "var(--onsen-color-blue-text-muted)" }}
            >
              {strings.ooc.empty}
            </p>
        ...
        <p
          className="chrome px-[22px] pt-[8px] text-[9px] leading-[1.5]"
          style={{ color: "var(--onsen-color-blue-text-muted)" }}
        >
          {strings.ooc.hint}
        </p>
...
function Bubble({
  ...
  return (
    <div className={`mb-[12px] flex flex-col ${fromReader ? "items-end" : "items-start"}`}>
      {name === null ? null : (
        <span
          className="chrome mb-[4px] text-[8.5px] tracking-[0.16em] uppercase"
          style={{ color: "var(--onsen-color-blue-text-muted)" }}
        >
          {name}
        </span>
