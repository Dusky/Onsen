...
export const strings = {
  ...
  chat: {
    ...
    versions: "Versions",
    deleteVersionConfirm: "Delete this version? Everything after it goes with it.",
    setup: "Setup",
    back: "‹",
    ...
    inspectorSkip: {
      ...
      trigger: "not for this turn",
      vectorized: "not enough in common",
    ...
    statsAi: "The cast",
    statsWords: "Words",
    statsByCharacter: "By speaker",
    statsCharacterLine: (messages: number, words: number) => `${messages} ${messages === 1 ? "turn" : "turns"} · ${words} ${words === 1 ? "word" : "words"}`,
    ...
    opSteerClear: "Clear",
    steerDepth: "Depth",
    steerDepthUnit: "turns back, 0 is now",
    steerInterval: "Every",
    steerIntervalUnit: "turn",
    steerRole: "As",
    opNoReply: "No reply",
    opRunOn: "Continue",
    opTools: "Tools",
  ...
  media: {
    ...
    serviceUrl: "Address",
    serviceModel: "Model",
    serviceModelNone: "(none)",
    comfyuiModelSaveFirst: "Save the service first, then pick a checkpoint from the endpoint.",
    comfyuiModelsNone: "No checkpoints found on the endpoint.",
    comfyuiModelsFailed: "Could not list checkpoints from the endpoint.",
    comfyuiModelManual: "Checkpoint name",
    serviceKey: "API key",
  ...
  lore: {
    ...
    copyTo: "Copy to…",
    duplicate: "Duplicate",
    noOtherBooks: "There is no other lorebook yet.",
    disabled: "Disabled",
    enable: "Enable",
    disable: "Disable",
    noKeys: "No keys",
    ...
    ignoreBudget: "Ignore the token budget",
    useProbability: "Roll probability",
    groupOverride: "Always wins its group",
    delayUntilRecursion: "Delay until recursion",
    delayUntilRecursionUnit: "round",
    filterExclude: "Exclude instead",
    vectorized: "Vectorized",
    vectorizedNote: "Matched by meaning, not keywords.",
    fireOn: "Fire on",
    fireOnHint: "None ticked means every turn.",
    fireOnNormal: "Normal",
    fireOnSwipe: "Reroll",
    fireOnRevise: "Rewrite",
    fireOnContinue: "Continue",
    matchAgainst: "Also match against",
    ...
    matchCharacterDepthPrompt: "Character depth note",
