...
export const strings = {
  ...
  chat: {
    ...
    opSteerClear: "Clear",
    steerDepth: "Depth",
    steerDepthHint: "turns back, 0 is now",
    steerInterval: "Every",
  ...
  lore: {
    ...
    ignoreBudgetHint: "Always survives the book's budget trim.",
    useProbability: "Roll probability",
    useProbabilityHint: "Off means it always fires when matched, never rolls.",
