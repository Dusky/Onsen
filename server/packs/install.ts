...
function entryPatch(source: Record<string, unknown>): Record<string, unknown> {
  ...
  return {
    ...
    character_filter_tags: list("characterFilterTags"),
    character_filter_exclude: flag(source, "characterFilterExclude", false) ? 1 : 0,
    ignore_budget: flag(source, "ignoreBudget", false) ? 1 : 0,
